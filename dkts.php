...
Plugin URI: https://www.marketingtechblog.com/tweetthis-shortcode/
...
function tweetthis_shortcode_options_page() { 
	...
	<p>Built by <a href="http://www.dknewmedia.com/" target="_blank">DK New Media</a>. Be sure to check out our publication, the <a href="https://www.marketingtechblog.com" target="_blank">Marketing Technology Blog</a> for the latest updates on WordPress and Marketing Technology!</p>
	<?php
}
...
function dkts_tweetthis( $atts, $dkts_content = null ) {
	...
	if( strlen($dkts_permalink) < 1) {
		$dkts_permalink = 'https://www.marketingtechblog.com/tweetthis-shortcode/';
	}
	...
	$dkts_urlcontent = substr( $dkts_content, 0, 140 );
